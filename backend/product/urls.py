...
urlpatterns = [
    ...
    # shopping cart
    path('add-to-cart/<int:pk>/', views.AddShoppingCartProduct.as_view(), name="add-to-cart"),
    path('remove-from-cart/<int:pk>/', views.DeleteShoppingCartProduct.as_view(), name="remove-from-cart")
]